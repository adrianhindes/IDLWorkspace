function perpParallelDiffusion, b = bField, te = eTemp, ti = ionTemp, $
 n_i=ionDens, del_ni = gradN, spec = species
...
if species eq 'hydrogen' then begin
  mi = !const.mp 
endif else begin
  mi=!const.mp*40 ;Argon ion mass
endelse
...
perp_nvflux_total = perp_nvflux_i + perp_nvflux_e
...
result = create_Struct("fluxPerpE",perp_nvflux_e,"fluxPerpI",perp_nvflux_i,"fluxTotal",perp_nvflux_total,$
"ionGRad",rgyro_i,"eGRad",rgyro_e,"collisionFreq",nuetotal,"ambipolarE",PerpAmbiE)
