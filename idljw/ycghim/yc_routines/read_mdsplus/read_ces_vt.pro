...
; Dr. Wonha Ko received on Sep. 4th. 2013.
  ...
  for i = 0, nch - 1 do begin
    ...
    dataname = 'ces_vt'+string(i+1, format='(i02)')
  ...
  ycshade, data, r_pos, time, xtitle = 'R [cm]', ytitle = 'Time ' + time_unit, ztitle = 'V_tor ' + data_unit, $
           title = string(shotnumber, format='(i0)') + ': Ion Toroidal Vel. from CES'
