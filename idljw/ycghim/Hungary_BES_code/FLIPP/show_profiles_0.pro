pro show_profiles,file,zrange=zrange,title=title,nolegend=nolegend,$
...
; Plots light profiles and fluctuation profiles 
...
load_zztcorr,shot,k,ks,z,t,file=file,profile=profile,backgr_profile,$
             ...
             channels=channels,tres=tres,trange=trange,$
...
default,zrange,[min(z)-0.5,max(z)+0.5]
...
if (backtimefile ne '') then begin  
  load_zztcorr,shot,k,ks,z,t,timefile=backtimefile,$
             ...
             cut_length=cut_length,data_source=data_source
