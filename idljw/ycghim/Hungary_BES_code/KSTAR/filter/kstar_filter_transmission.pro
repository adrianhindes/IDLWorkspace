pro kstar_filter_transmission,shot,click=click,ebeam = ebeam,ray_divergence=ray_divergence,$
...
;******************************************************************************
; Calculate the transmission of the filter in the trial KSTAR BES system for  *
;* all channels.                                                              *
;* INPUT:                                                                     *
;*   shot: Shot number                                                        *
  ...
  for j=0,7 do begin
    ...
    for i_int_r=0,rmax-1 do begin
      ...
      for i_int_a=0,amax-1 do begin
        ...
        ; Rotating around x axis by angle_filt
