...
;*****************************************
pro apdcam_control,offline=offline_in
@apdcam_common.pro
...
apd_spareio1_widg = widget_droplist(apd_spareio_base_widg1,value=['Mirror in','Mirror out'])
apd_spareio2_widg = widget_droplist(apd_spareio_base_widg1,value=['APDCAM','EDICAM'])
