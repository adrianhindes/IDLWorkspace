...
;           0: Measurement not finished (aborted)
  ...
  default,meastime,10
  default,bits,12
  default,trigger,0  ; If <0 then manual start, otherwise delay
...
@apdcam_common.pro
  ...
  if (event.ID eq kstar_start_widg) then begin
    ...
    if (meas_status ne 0) then begin
      ...
      ; Writing config file
      ;val1 = widget_info(apd_spareio1_widg,/droplist_select)
      ;mirror_pos = Mirror_Positions[val1]
      ;val2 = widget_info(apd_spareio2_widg,/droplist_select)
      ;camera_select = Camera_Select_States[val2]
      
      widget_control,apd_spareio1_widg,get_value=mirror_pos
      widget_control,apd_spareio2_widg,get_value=filter_pos
      widget_control,apd_spareio3_widg,get_value=filter_temp
      widget_control,apd_spareio4_widg,get_value=apd_pos
      ...
      widget_control,kstar_status_widg,set_value='Copying data to shot directory'

      ; Copying data
      cmd = 'copy '+dir_f_name('data','Channel*.dat')+' '+dir_f_name('data',shotdir_new)
      spawn,cmd

      widget_control,kstar_status_widg,set_value='Plotting results'
      wset,kstar_plot_window
      show_all_kstar_bes,shotnumber,yrange=[-0.02,1],int=1000
...
apd_spareio1_widg = cw_field(apd_spareio_base_widg1, title='Mirror position:',value=0, /int,xsize=5,/return_events)
apd_spareio2_widg = cw_field(apd_spareio_base_widg1, title='Filter position:',value=0, /int,xsize=5,/return_events)
apd_spareio3_widg = cw_field(apd_spareio_base_widg1, title='Filter temperature:',value=0, /int,xsize=5,/return_events)
apd_spareio4_widg = cw_field(apd_spareio_base_widg1, title='APD position:',value=0, /int,xsize=5,/return_events)
...
apd_timing_widg=widget_base(title='APD Timing',xoff=600,yoff=400,event_pro='apd_timing_event',col=1)
...
apd_filterfreq_widg = cw_field(apd_timing4_widg,title='FIR Freq.[MHz]',value=' ?? ',xsize=6,/string,/return_events)
apd_filterfreq_int_widg = cw_field(apd_timing4_widg,title='Rec. Freq.[MHz]',value=' ?? ',xsize=6,/string,/return_events)
apd_filtergain_widg = cw_field(apd_timing4_widg,title='Filter gain [0,1..]',value='3 ',xsize=2,/string,/return_events)


apd_timing_widg2=widget_base(apd_timing_widg,col=3)
apd_trigger_widg = cw_bgroup(apd_timing_widg2,['Trig +','Trig -', 'Max. trig'],/nonexclusive,/frame)
apd_inttrig_opt_widg = cw_bgroup(apd_timing_widg2,['Int trig en','+ trig'],/nonexclusive,/frame)

apd_triggerbase_widg = widget_base(apd_timing_widg2,column=1,/frame)
apd_trigdelay_widg = cw_field(apd_triggerbase_widg,title='Trigger delay:',value=' ?? ',xsize=6,/string,/return_events)
apd_triglevel_widg = cw_field(apd_triggerbase_widg,title='Trigger level:',value=' ?? ',xsize=6,/string,/return_events)
apd_ringbufsize_widg = cw_field(apd_triggerbase_widg,title='Ring buffer:',value=' ?? ',xsize=6,/string,/return_events)
...
kstar_dataplot_widg=widget_draw(kstar_widg,xsize=1368,ysize=600,retain=2)
