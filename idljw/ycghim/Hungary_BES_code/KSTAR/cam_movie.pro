 pro cam_movie, shotnum=shotnum, frames=frames, ver=ver, level=level, file=file, $
...
default,datapath,'~/Measurement/data/'+i2str(shotnum)
...
print,'Reading data...'
restore,datapath+'/'+i2str(shotnum)+'_CMOS_data.sav'
print,'...done'
