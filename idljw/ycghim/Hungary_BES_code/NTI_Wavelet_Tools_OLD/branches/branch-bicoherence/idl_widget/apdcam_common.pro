common apdcam_common,ADC_board,PC_board,apd_find_widg,apd_exit_widg,apd_widg,apd_id_widg,$
                 ...
                 apd_timing_widg,apd_pllmult_widg,apd_plldiv_widg,apd_streammult_widg,apd_streamdiv_widg,apd_create_widg,$
                 ...
                 apd_meas_load_widg,apd_ftype_log_widg,apd_frange1_widg,apd_frange2_widg,apd_fres_widg,apd_prange1_widg,apd_prange2_widg,$
                 apd_measurement_widg,apd_startblock_widg,apd_alivebutton_widg,apd_startbutton_widg,apd_stopbutton_widg,$
                 apd_statusblock_widg,apd_shotnumber_widg,apd_statustext_widg,stop_signal,cycle_running,exit_program,$
                 measurement_running,offline,alive_im_1,alive_im_2,alive_im_stat,apdsettings_widg,apd_start_widg,$
                 apd_end_widg,apd_exp_widg,apd_ch_cxrs_widg,apd_control_widg,load_textor_defaults,ext_clock_sign_freq,$
                 apd_loadtextor_widg,apd_cleanup,shotnumber,test,self_test,default_path,int_clock_sign_freq,max_sampl_freq,$
                 apd_modeblock_widg,apd_measmode_widg,shutter_open_enable,HV1_cycle,HV1_meas,HV1_max,HV_enable,$
                 apd_hv_shutter_widg,apd_hv_shutter_chkbox_widg,meas_mode
...
common apd_registers,ADC_REG_MC_VERSION,ADC_REG_SERIAL,ADC_REG_FPGA_VERSION,ADC_REG_STATUS1,ADC_REG_STATUS2,$
  ...
  PC_REG_ERRORCODE,ADC_REG_ERRORCODE,PC_REG_SHMODE,PC_REG_CALLIGHT
