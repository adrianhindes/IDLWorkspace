...
function pg_mirphase_sim,timeax=timeax,trange=trange

default,shot,1
default,sampletime,5e-6
default,t_drop,10e-6
default,t_rec,30e-6
default,a_drop,1
default,f_forg,8000
default,f_mhd,2000
default,m,3.
default,n_event,1000
default,trange,[0.4,0.6]
default,theta,[10,30,50,85,100,120,145,165,185,200,220,255,275,305,340,355]/360.*2*!PI
default,snr,0.5

np = long((trange[1]-trange[0])/sampletime)
t = findgen(np)
amp_mir = fltarr(np)
sig_mir = fltarr(16,np)
