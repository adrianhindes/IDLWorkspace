...
default,tstart,-0.03
default,tend,  -0.002
default,fit_length,tend-tstart
default,plot,1
default,norm,1
default,thr,0.1 ;10%
default,ylog,1
...
for i=0,N-1 do begin
   ...
   plot,timeaxes_normed(i,*),bpv(0,*,i),title='Bandpower fit of '+crash_group+': #'+i2str(i)+$
   ...
   datas_fit_mean='MEAN and STD(%) of the '+i2str(N)+' weighted averaged params:'+$
