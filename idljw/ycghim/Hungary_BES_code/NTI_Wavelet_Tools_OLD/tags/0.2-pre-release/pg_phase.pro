...
channel='W7-AS Mirnov/Mir-1-'+i2str(startch)
...
for j=1,16 do begin
	...
	if cplot then begin
		...
		if rawsignal then title='Crosscorrelation of signals of channels '+i2str(startch)+'-'+i2str(j) $
			else title='Crosscorrelation of band power '+str[0]+' of channels '+i2str(startch)+'-'+i2str(j)
