...
;		[,y2title] [,title] [,opt] [,/ylog] [,/zlog] [,/original] [,/nearest] [,/poster]
;
; Input:
...
; Output: -
;
; Modified: Automatic resize of matrix in pg_otv (Gergo Pokol, 2007.02.23)

pro pg_plot4, matrix, ct=ct, xrange=xrange, yrange=yrange, y2range=y2range, zrange=zrange, intz=intz,$
	data=data, xtitle=xtitle, ytitle=ytitle, y2title=y2title, title=title, ylog=ylog, zlog=zlog,$
	opt=opt, original=original, nearest=nearest, poster=poster
