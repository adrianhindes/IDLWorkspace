...
if keyword_set(print) then begin
	set_plot, 'PS'
	if keyword_set(portrait) then device, bits_per_pixel=8, font_size=8, /color, /portrait, /bold, /cmyk, /times $
	else device,bits_per_pixel=8,font_size=8,/color,/landscape,/bold,/cmyk,/times
endif else begin
