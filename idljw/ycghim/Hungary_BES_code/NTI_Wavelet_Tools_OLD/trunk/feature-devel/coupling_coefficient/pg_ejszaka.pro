...
;	for ch=3,3 do begin
;		coh=pg_cscalogram([shot,shot],['W7-AS Mirnov/MIR-1-1','W7-AS Mirnov/MIR-1-'+i2str(ch)],trange=[0.45,0.55],order=36,dscale=0.05,plot=1,inttime=1,opt=0.2,phaselevel=3,/print,/pad)
;	endfor
;endfor

;for shot=56796,56796 do begin
;	for ch=1,16 do begin
;		stft=pg_spectrogram(shot,'W7-AS Mirnov/MIR-1-'+i2str(ch),windowsize=100,masksize=600,step=20,freqres=1,plot=1,/print,opt=0.12)
;	endfor
;endfor
...
;for shot=56796,56796 do begin
;	for ch=1,16 do begin
;		stft=pg_spectrogram(shot,'W7-AS Mirnov/MIR-1-'+i2str(ch),trange=[0.32,0.6],windowsize=100,masksize=600,step=20,freqres=1,plot=1,/print,opt=0.25)
;	endfor
;endfor
...
;for i=2,16 do begin
;	cwt=pg_cscalogram([52153,52153],['W7-AS Mirnov/MIR-1-1','W7-AS Mirnov/MIR-1-'+i2str(i)],trange=[0.4,0.6],order=10,$
