...
;Startblock:
  ...
  nti_wavelet_gui_numchannels_widg, $
;Processing block:
  ;Others:
  ...
  nti_wavelet_gui_process_transfparam_widg, $
    ;CWT
  ...
  nti_wavelet_gui_process_freqrange_help_widg, $
  ...
  nti_wavelet_gui_process_coh_help_widg, $
  ...
  nti_wavelet_gui_process_mode_filter_widg, nti_wavelet_gui_process_mode_help_widg, $
...
;Visualization:
  nti_wavelet_gui_visual_widg, $

  ;General settings:
  nti_wavelet_gui_visual_label_widg, nti_wavelet_gui_visual_genset_widg, $
  nti_wavelet_gui_visual_genset_label_widg, nti_wavelet_gui_visual_genset_linfreqax_widg, $
