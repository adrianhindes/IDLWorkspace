...
version=1.14
prog='gp_analyse.pro'
if not keyword_set(ID) then ID=i2str(systime(1))
...
default,adaptive,1
default,hann,1
default,blocksize,256
default,treshold,0
default,apsd_y_max,10000
default,apsd_y_min,0.0001
...
;calculating correlation functions with Fourier-technique
    ...
    datas='shot:   '+pg_num2str(shotnumber,length=5)+'  N: '+i2str(n_points)+'  Blocksize: '+i2str(blocksize)+$
          '!CCh1:    '+channel1+$
          '!CCh2:    '+channel2+$
          '!Ctrange: '+pg_num2str(tstart,length=6)+' s - '+$
          pg_num2str(tend,length=6)+' s'
          
    datas1='shot:   '+pg_num2str(shotnumber,length=5)+'  N: '+i2str(n_points)+'  Blocksize: '+i2str(blocksize)+$
          '!CCh:    '+channel1+$
          '!Ctrange: '+pg_num2str(tstart,length=6)+' s - '+$
          pg_num2str(tend,length=6)+' s'     
          
    datas2='shot:   '+pg_num2str(shotnumber,length=5)+'  N: '+i2str(n_points)+'  Blocksize: '+i2str(blocksize)+$
          '!CCh:    '+channel2+$
          '!Ctrange: '+pg_num2str(tstart,length=6)+' s - '+$
          pg_num2str(tend,length=6)+' s' 
