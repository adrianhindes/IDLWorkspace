;This function calculates the spectrogram of BES signal

FUNCTION bes_spectrogram, shot, ch1, ch2, $
...
; Extract the filter signal
  ...
  raw_tvector = d1.tvector[s1.inx_nonzero_begin:s1.inx_nonzero_end]
