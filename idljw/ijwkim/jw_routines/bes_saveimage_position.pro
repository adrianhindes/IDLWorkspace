...
FUNCTION bes_saveimage_position, shot, plot = plot, datapath=datapath, fusion01=fusion01, bes03=bes03, ijwkim=ijwkim
...
;        NOTE: default location is ijwkim                                                             *
...
;******************************************************************************************************
; Special notes (written on the 18th. Dec. 2012):                                                     *
...
;  endelse
  ...
  if KEYWORD_SET(datapath) then begin
    ...
    if KEYWORD_SET(ijwkim) then begin
      ...
      fname = '/home/ycghim/Research/KSTAR/BES/raw_data/' + str_shotnumber + '/' + str_shotnumber + '.spat.cal'
      config_fname = '/home/ycghim/Research/KSTAR/BES/raw_data/' + str_shotnumber + '/' + str_shotnumber + '_config.xml'
...
;    datapath = '/home/ijwkim/Research/KSTAR/BES/spatial_info/' ; reading from fusion01 server (KAIST server)
;  endif else begin
;    datapath = '/home/ycghim/Research/KSTAR/BES/raw_data' ;reading from BES03 server (KSTAR server)
;  endelse
;  str_shotnumber = STRCOMPRESS(STRING(shot, format='(i0)'), /rem)
;  if KEYWORD_SET(fusion01) then begin
;    fname = datapath + '/' + str_shotnumber + '.spat.cal'
;  endif else begin
;    fname = datapath + str_shotnumber + '/' + str_shotnumber + '.spat.cal'
;  endelse
;  OPENR, inunit, fname, /get_lun, error = err
...
; plot the BES positions
  if plot eq 1 then begin
    ...
    yspan = ymax - ymin
    window, shot mod 10, xsize=800, ysize=600
