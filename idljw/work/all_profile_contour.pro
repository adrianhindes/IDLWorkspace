pro all_profile_contour


points_num = 41
points_ax = 5
probe_rad = ptrarr(points_ax)
...
for i = 0, points_num-1 do begin
  shot_number = i*3+1376;2939;2911;2857;2720;2777
;  if shot_number gt 3319 then begin
;    shot_number = (i-9)*3+2857
;  endif
  probe_rad[i] = ptr_new(phys_quantity(shot_number))
endfor
...
;  probe_rad_location[i] = 77.2+2.5*i
  probe_rad_location[i] = 0.0+0.25*i-2.5
