...
for i = 0, points_num-1 do begin
  shot_number = i*3+2937     ;2937;3294;2939;2911;2857;2720;2777
...
;points_num2 = 41
;probe_1d = ptrarr(points_num2)mean(vplus_data(end-10000:end))
...
;pmt[3] = ptr_new(magpie_data('single_pmt',1622))mean(vplus_data(end-10000:enmean(vplus_data(end-10000:end))d))
...
;window_npts = 4L*subwindow_nptsmean(vplus_data(end-10000:end))
