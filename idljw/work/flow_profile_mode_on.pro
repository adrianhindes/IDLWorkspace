...
for i = 0, points_num-1 do begin
  shot_number = i*3+3736;3737   ;3620;3324;2939;2911;2857;2720;2777
  shot_temp = i*3+3338
...
;  
  ...
  temp_error[i] = sqrt(variance(temp_cut.yvector))/sqrt(size(temp_cut.yvector,/n_elements))
...
ycplot, probe_ax_location, temp_mean, error = temp_error
