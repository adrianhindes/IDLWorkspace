pro jan_isat,sh,xr=xr,fr=fr,zrm=zrm,zri=zri,df=df,dt=dt,nohan=nohan,minc=minc
default,dt,3e-3
default,df,3e3
default,fr,[0,200e3]
default,zrm,[-7,-2]
...
plot,cur.t,cur.v,pos=posarr(2,4,0),title='cur #'+string(sh,format='(I0)'),xsty=1,xr=xr,/yno

spectdata2,interpol(cur.v,cur.t,mirn.t),ps,t1,f1,t0=min(mirn.t),fdig=1/(mirn.t(1)-mirn.t(0)),dt=dt,nohan=nohan,df=df
imgplot,alog10(ps),t1,f1,pos=posarr(/next),/noer,title='ps cur',xr=!x.crange,xsty=1,/cb,zr=zri,yr=fr
