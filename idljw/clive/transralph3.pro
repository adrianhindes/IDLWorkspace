...
path='~/rsphy/newwrl/'
restore,file=path+fil+'2show.sav',/verb
path2='~/idl/clive/nleonw/gregali/'
restore,file=path2+'irset.sav',/verb & viewcsys=str
restore,file=path2+'irsetmirr2.sav',/verb & viewbfit=str
...
aa=2&viewbfit.flen=1/viewbfit.flen&viewcsys.flen=1/viewcsys.flen

applyp0,fcb,p0bfit
applyrot,fcb,xhatbfit,yhatbfit,zhatbfit
fcb(0:aa,*,*)*=1./viewbfit.flen ;fw
fcb(0:aa,*,*)*=viewcsys.flen;inv
applyrot,fcb,ixhatcsys,iyhatcsys,izhatcsys
applyp0,fcb,-p0csys

applyp0,lns,p0bfit
applyrot,lns,xhatbfit,yhatbfit,zhatbfit
lns(0:aa,*,*)*=1./viewbfit.flen ;fw
lns(0:aa,*,*)*=viewcsys.flen;inv
