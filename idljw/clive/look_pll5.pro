...
default,fr,[1,100]
if !version.os eq 'Win32' then dir='D:\MDSPLUS_DATA\PLL2_DATA\' else dir='~/pll2/'
...
if n_elements(nba) ne 0 and not keyword_set(dolen) then idx=idx(0)+lindgen(nba)
idx0=idx
