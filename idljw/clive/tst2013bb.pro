...
ifr=ifr0+4*8&only2=1&demodtype='sm32013mse';sm32013mse'
...
for kk=0,nn-1 do begin
   ifr=ifr0+4*kk&only2=0&only1=1

   newdemodflclt,sh, ifr,dopc=dopc1,angt=ang1x,eps=eps1x,ix=ix2,iy=iy2,pp=p,str=str,only2=only2,only1=only1,cars=cars1,istata=istata1,demodtype=demodtype,/noid2,db=db,/lut
