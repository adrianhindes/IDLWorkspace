...
if keyword_set(jp) then begin
    ...
    if !version.os ne 'Win32' then begin
        spw='/usr/bin/gs -sDEVICE=jpeg -sOutputFile='+fnamej+' -dNOPAUSE -dBATCH -dSAFEr -dJPEGQ=85 -r300 -dEPSCrop -dTextAlphaBits=4 -dGraphicsAlphaBits=4 '+fnamew
...
;            spw='C:\gs\gs8.60\bin\gswin32.exe -IC:\gs\gs7.00\lib;C:\gs\fonts -sDEVICE=jpeg -sOutputFile='+fnamej+' -dNOPAUSE -dBATCH -dSAFEr -dJPEGQ=85 -r300 -dEPSCrop -dTextAlphaBits=4 -dGraphicsAlphaBits=4 '+fname
   ...
   spw='"C:\Program Files\gs\gs9.07\bin\gswin64" -sDEVICE=jpeg -sOutputFile='+fnamej+' -dNOPAUSE -dBATCH -dSAFEr -dJPEGQ=85 -r300 -dEPSCrop -dTextAlphaBits=4 -dGraphicsAlphaBits=4 '+fname
...
if !version.os ne 'Win32' then spawn,'/usr/bin/gv '+string(fname)+' &' else $
   spawn,'"C:\Program Files\Ghostgum\gsview\gsview64" '+string(fname)
endif
