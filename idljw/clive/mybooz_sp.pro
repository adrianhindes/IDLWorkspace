...
readpatch,99998,db='greg',str,nfr=1
...
inten=rhopts le 0.99 ;and rhopts ge 0.2
...
read_spe,'~/share/greg/shaun_83982.spe',l,t,d &lc0=[658,668,656];667
...
plotm,sig>0,xtitle='Spectrometer channel',ytitle='signal',title='P=2.54,fill=0.5,phase=p00'
;linten=shift(linten,-1)
plot,reverse(linten),/noer,col=4,xsty=4,ysty=4
legend,['706nm','10 x 728nm (cal inc)','726nm (noline)','forward model,const emissiv' ],textcol=[1,2,3,4],/right,box=0
;plot,sig(*,1)/sig(*,0),yr=[0,3],/noer,col=6
;imgplot,linten2,ix1,iy1,pos=posarr(2,1,0),/iso,title='calculated image, intenisty=ring round rho=.8'
endfig,/gs,/jp
end
