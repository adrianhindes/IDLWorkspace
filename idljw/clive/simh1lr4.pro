...
par=[vcore,tcore,lr,lr2,v2,tedge] ;,tedge,vcore2,tcore2,vcore3,tcore3, ap1,aa0_2,aa0_2,tedge,tedge,ap1_2,ap1_3]*1d0
common cbb,cl0,cl1,cl2
...
met(cnt,*)=dihes
print,'errors','dv=',dihes(0),'dt=',dihes(1),'drat=',dihes(2),'drat2=',dihes(3),'dv2=',dihes(4),'dt2=',dihes(5)
