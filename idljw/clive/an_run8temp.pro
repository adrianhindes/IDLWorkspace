...
[2     ,  0.5],$
[2.54  ,  0.5]]
jjphase=[replicate('normal',6),'m90_0','p00']
...
;typ=1
      ...
      title=string(jjtab(0,jj),jjtab(1,jj),jjphase(jj),format=$
                   '("P=",G0," fill=",G0," phase=",A)')
   ...
   plot,r,tesw,psym=4,yr=minmax([-10,40]),pos=pos,/noer,title=title,xr=[122,136],xsty=1,ysty=1,yticklen=1,ygridsty=1
   pos=posarr(/next)
   oplot,r,tebp,psym=5,col=2
   legend,['sw','bp','he_lr'],psym=[4,5,6],/right,col=[1,2,4],textcol=[1,2,4]
