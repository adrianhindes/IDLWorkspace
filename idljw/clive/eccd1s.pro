;goto,ee
tr=[1,8]
sh=9323 & freqshot=2. & tr2=[2,4]

;sh=9326 & freqshot=10. & tr2=[2,7]
;sh=9327 & freqshot=10. & tr2=[1.5,4]
...
tmp0=transpose(reform(res.ang(*,30,*)))-12
for j=1,9 do tmp0+=transpose(reform(res.ang(*,30+j,*)))-12
tmp0 = tmp0/10
tr=[1,8]
sh=9323 & freqshot=2. & tr2=[1.5,4]
...
contourn2,tmp(*,ix),res.t,res.r1(ix),zr=[-20,20]/10,pos=posarr(1,3,0,cny=0.1,cnx=0.1),pal=-2,offx=1,/cb,$
