...
em=reform(total(cd.neutrals.srspectra0,2),nx,ny,nz)     
...
iz0=sz(1)/2
nrhon=100
rhon=linspace(140,230,nrhon)
em2=fltarr(sz(0),nrhon)
for i=0,sz(0)-1 do begin
in=where(rhor(i,iz0,*) ne 0)
em2(i,*)=interpolo(emr(i,iz0,in),rhor(i,iz0,in),rhon)
plot,rhor(i,iz0,*),emr(i,iz0,*),title=i
stop
endfor

in=where(finite(rhoav) eq 0)
if in(0) ne -1 then rhoav(in) = 232.
contourn2,em2,rhoav(*,iz0),rhon,/cb
stop
