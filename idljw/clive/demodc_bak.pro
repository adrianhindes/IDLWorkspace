pro demodc, img,c1,c2a,c2b,s3,c1r,c2ar,c2br,p2a,p2b,win=win,idxng=idxng,sub=sub,wintype=wintype,sgexp=sgexp,sgmul=sgmul,pixfringe=pixfringe,thres=thres,typthres=typthres,calcref=calcref,doplot=doplot,aoffs=aoffs,zr=zr
default,thres,0.1
...
rad=r0/2 / 2; for half harmonic no contam
fimgsub(0,0)=0.
...
default,zr,[-1,1]
imgplot,alog10(abs(fimgsubs)),ixs,iys,xr=xr,yr=yr,/iso,/cb,zr=zr
