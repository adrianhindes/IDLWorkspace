...
par2={crystal:'linbo3',thickness:25e-3,lambda:lam*1e-9,facetilt:0*!dtor}
par3={crystal:'linbo3',thickness:0e-3,lambda:lam*1e-9,facetilt:0*!dtor}
par4={crystal:'calcite',thickness:1.5e-3,lambda:lam*1e-9,facetilt:45*!dtor}
par5={crystal:'bbo',thickness:0,lambda:lam*1e-9,facetilt:45*!dtor}
