...
nl=201
getptsnew,pts=pts,str=str,bin=8,/pptsonly,lene=[100,300],nl=nl,nx=nx,ny=ny,detx=detx,dety=dety,ix=ix1,iy=iy1,leno=len1
dl = 0.01
...
ss=myrest2('~/idl/clive/nleonw/antport2/objhidden_zb.sav')
...
mm=4.
nn=3.
inten=exp(-(rhopts - a0r)^2 / a0w^2) * cos(mm*thpts +3*nn* ptsc(*,*,1)) * (rhopts lt 0.99)
...
contourn2,linten2/1e17,ix1,iy1,/cb,title=textoidl('Modeled H_{\alpha}'),offx=1,ztitle=textoidl('10^{17} ph/s/m^2/str'),/iso,xsty=5,ysty=5,pos=posarr(2,1,0),pal=-2

contourn2,lintenb2/1e17,ix1,iy1,/cb,title=textoidl('Modeled H_{\alpha}'),offx=1,ztitle=textoidl('10^{17} ph/s/m^2/str'),/iso,xsty=5,ysty=5,pos=posarr(/next),/noer,pal=-2
