...
t0=0.
p=a
f=  s0*     (1 + Cos(2*(t0 + th))*(Cos(2*p)^2 + Cos(d)*Sin(2*p)^2) + $
         Sin(d/2.)^2*Sin(4*p)*Sin(2*(t0 + th)))/2.
end
...
;sh=1642&i0=1
;sh=1643&i0=1
path='/data/kstar/MSE_DATA';'/home/cam112/prlpro/res_jh/mse_data'
...
;ll=l(i0:i0+17)-(sh lt 1700 ? l(22) : 139)
ll=l(i0:i0+17)-l(22);(sh lt 1700 ? l(22) : 1556)

th=linspace(0,170,18)*!dtor
plot,th,ll,psym=-4
a0=[5*!dtor,175*!dtor,3.5e4]
;a0=[  44.9967,      133.113     , 62114.9]*[!dtor,!dtor,1]
;a0=[44.9967   ,   0.    ,  62114.9]*[!dtor,!dtor,1]
...
;newdata with lex 14/aug/2014.
;1700/1 - oldflcrising/falling, 1702-poalriser only
