...
;pre='run' & istart=137 ; took windows off, set to 5, then turned up to 7 and put ffan on

;pre='tsk' & istart=20 ; took windows off, set to 5, then turned up to 7 and put ffan on
...
setsnn={win:{type:'sg',sgmul:1.5,sgexp:4},$
