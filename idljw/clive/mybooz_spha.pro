...
oplot,!x.crange,[0,0]
oplot,1.307*[1,1],!y.crange
oplot,1.27*[1,1],!y.crange
endfig,/gs,/jp
stop
...
inten0=(rhogrid3 le 0.99) * 5.5e17
...
read_spe,'~/share/greg/ipad_500ms_portwin_wed.spe',l,t,d,str=strcal
lcal=reverse(l)
;this is 660nm
...
factor0a=totaldim(d(*,*,50:70),[0,0,1])/21. / strcal.texp / strcal.avgain
...
for i=0,nl-1 do begin
   ...
   sig(*,i) = (total(d(ix,*,iframe),1) - total(d(ix,*,iframe0),1)) * dl
   sig(*,i) = sig(*,i) / factor1
;   print,i,lc0(i)
