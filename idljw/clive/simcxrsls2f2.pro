...
for kk=0,2 do begin
    if kk eq 0 then begin
        ...
        fp1=ap1 * fgaussof(delay,l1,0,ctemp1)
    endif
    if kk eq 1 then begin
        fa0=aa0_2 * fgaussof(delay,l0,vcore2,tcore2) 
        fp0=ap0_2 * fgaussof(delay,l0,0,tedge_2)
        fp1=ap1_2 * fgaussof(delay,l1,0,ctemp1)
    endif
    if kk eq 2 then begin
        fa0=aa0_3 * fgaussof(delay,l0,vcore3,tcore3) 
        fp0=ap0_3 * fgaussof(delay,l0,0,tedge_3)
        fp1=ap1_3 * fgaussof(delay,l1,0,ctemp1)
    endif

    ftottmp=(fa0+fp0+fp1)/(aa0+ap0+ap1)
...
par=[vcore,tcore,aa0,tedge,vcore2,tcore2,vcore3,tcore3, ap1,aa0_2,aa0_2,tedge,tedge,ap1_2,ap1_3]*1d0
common cbb,cl0,cl1,cl2,cap1,cap2,ctedge,ctemp1
cl0=l0
cl1=l1
cl2=l2
...
dinc=[358,$;3+6
      ...
      596];5
nn=4
for i3=0,1 do for i1=0,nn-1 do for i2=0,nn-1  do begin ;i1+xx,nn do for i3=i2+xx,nn do for i4=i3+xx,nn do begin
    iarr(0,cnt)=i1
    iarr(1,cnt)=i2
    iarr(2,cnt)=i1+i2
