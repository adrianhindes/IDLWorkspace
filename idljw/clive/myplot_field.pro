; $Id: //depot/Release/IDL_81/idl/idldir/lib/plot_field.pro#1 $
;
...
;-
PRO myPlot_field,U,V,N=N,LENGTH=length,ASPECT=aspect, title= title,position=position,noerase=noerase
...
plot,[0,1,1,0,0],[0,0,1,1,0],title=title,/nodata, pos = position,noerase=noerase
