...
mkfig,'~/tex/ishw/fluxkvdiff.eps',xsize=8,ysize=9.6,font_size=8

plot,interf.t,interf.v>0,xr=[0,.1],pos=posarr(1,3,0,cnx=0.13,cny=0.1,msraty=7),ysty=8,xtickname=replicate(' ',10),title=textoidl('Line av. density & \kappa_h'),ytitle=textoidl('n_e (10^{18} m^{-3})')
...
plot,y.t,y.v>0,/noer,xr=!x.crange,pos=posarr(/next),xtickname=replicate(' ',10),title=textoidl('I_{sat} (R=132cm, r/a=0.7)'),ytitle='A'
...
legend,['fluctuation-induced flux','total flux'],col=[1,2],textcol=[1,2],psym=[-4,-4],linesty=[0,0],box=0
endfig,/gs,/jp
