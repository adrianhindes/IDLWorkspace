pro demodc, img,c1,c2a,c2b,s3,c1r,c2ar,c2br,p2a,p2b,win=win,idxng=idxng,sub=sub,wintype=wintype,sgexp=sgexp,sgmul=sgmul,pixfringe=pixfringe,thres=thres,typthres=typthres,calcref=calcref,doplot=doplot,aoffs=aoffs,zr=zr,noopl=noopl,fracbw=fracbw
default,thres,0.1
...
r2=r1
default,fracbw,0.5
rad=r0/2 * fracbw; for half harmonic no contam
;fimgsub(0,0)=0.
...
if not keyword_set(noopl) then oplot,ixs,ixs*tan(a0),col=4
...
imgplot,shift((alog10( abs(fimgsub * f0)>1e-5 )), szs(0)/2-1,szs(1)/2-1),ixs,iys,/iso,/cb,title='f0',xr=xr,yr=yr,pos=pos,/noer,zr=zr&pos=posarr(/next)
...
nl=2
cont=0
imgplot,abs(c0),/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='c0',zr=zraa&pos=posarr(/next)
imgplot,abs(c1),/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='d2'&pos=posarr(/next)
imgplot,abs(c2a),/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='d1+d2'&pos=posarr(/next)
imgplot,abs(c2b),/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='d1-d2'&pos=posarr(/next)
imgplot,abs(c2a)+abs(c2b),/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='d1+d2 plus d1-d2'&pos=posarr(/next)

imgplot,s3a,/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='s3/d1+d2'&pos=posarr(/next)
imgplot,s3b,/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='s3/d1-d2'&pos=posarr(/next)
imgplot,s3c,/cb,/iso,pos=pos,/noer,cont=cont,/rev,nl=nl,title='s3/d1+d2 plus d1-d1'&pos=posarr(/next)
...
c2a(idxng)=!values.f_nan
c2b(idxng)=!values.f_nan
