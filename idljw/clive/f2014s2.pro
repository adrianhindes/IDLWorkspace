...
if case1 eq 'new' and bm eq 1 and ex eq '95b' then begin
sh=10608 & twant=0.91& multiplier=1&db='kl' ; one recomended by ntm eccdguy (young)
endif

if case1 eq 'new' and bm eq 1 and ex eq '80' then begin
sh=10559 & twant=0.92& multiplier=1&db='kl'
endif

if case1 eq 'new' and bm eq 1 and ex eq '80b' then begin
sh=10611 & twant=0.91& multiplier=1&db='kl'
endif
...
f2014s,'new',1,d95,ex='95b'
f2014s,'new',1,d80,ex='80b'
analbeam6,0,ans95x,ans95,1.,0,cmno=531,switchans=0;,cwl=660.
analbeam6,0,ans80x,ans80,1.,0,cmno=533,switchans=0;,cwl=660.
