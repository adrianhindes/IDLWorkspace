...
;img=imglight;dark;light;dark;dark;light                    ;imgdark ; pass+act
;goto,nopl
...
;imgplot,-res.res2,pal=-2,/cb,zr=[-1,1]  
;imgplot,atan2(correction(*,*,jj(1))/correction(sz(0)/2,sz(1)/2,jj(1)))/2/!pi,/cb,pal=-2,zr=[-1,1],xsty=1,ysty=1 
...
;a0=mygaussfit(1,a)
;xmach=1e-3
;print,((mygaussfit(1,a+[1,0,0,0]*xmach))(0)-a0(0))/xmach,a0(1)
;print,((mygaussfit(1,a+[0,1,0,0]*xmach))(0)-a0(0))/xmach,a0(2)
;print,((mygaussfit(1,a+[0,0,1,0]*xmach))(0)-a0(0))/xmach,a0(3)
;print,((mygaussfit(1,a+[0,0,0,1]*xmach))(0)-a0(0))/xmach,a0(4)
;top
;stop
;ystart=(mygaussfit(x,a))(0,*)

yfit = LMFIT( x, y2, A , CHISQ=chisq , CONVERGENCE=convergence , FUNCTION_NAME='mygaussfit', ITER=iter, SIGMA=sigma ,itmax=1000,/double,fita=[1,1,1,1],measure_errors=dy2)
apar(dx,dy,*)=a
...
aparact=apar
save,aparact,intact,file='~/idl/clive/settings/aparact1.sav',/verb
