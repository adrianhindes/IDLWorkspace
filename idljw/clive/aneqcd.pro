...
j=j1+j2
;mkfig,'~/efit_jmid11003.eps',xsize=13,ysize=11,font_size=7
plot,g.r,j1(*,iz0),yr=[-1e6,4e6],ysty=1,xtitle='R (m)',ytitle='j (A/m^2)',$
     title='comparison of #11003 at t=3.45s (noeccd, solid lines) and 3.70s (w/eccd, dashed lines)',/nodata
oplot,!x.crange,[0,0]
oplot,g.r,j1(*,iz0),col=2
oplot,g.r,j2(*,iz0),col=3
oplot,g.r,j(*,iz0),col=4
...
oplot,g.r,j_2(*,iz0),col=4,linesty=2
