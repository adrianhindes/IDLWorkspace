...
if opt eq 'a5' then begin
    restore,file='~/idl/andover_scan_5.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a5b' then begin
    restore,file='~/idl/andover_scan_5b.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a5c' then begin
    restore,file='~/idl/andover_scan_5c.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a4b' then begin
    restore,file='~/idl/andover_scan_4b.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a4c' then begin
    restore,file='~/idl/andover_scan_4c.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif

if opt eq 'a3' then begin
    restore,file='~/idl/andover_scan_3.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a4' then begin
    restore,file='~/idl/andover_scan_4.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a2' then begin
    restore,file='~/idl/andover_scan_2.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
if opt eq 'a1' then begin
    restore,file='~/idl/andover_scan_1.sav'
    nl=n_elements(transmission)
    lam=findgen(nl)
endif
