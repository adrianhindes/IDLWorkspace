...
imgplot,vstore2(*,0:istore-1),r,t,xtitle='minor radius (m)',ytitle='time (s)',title='loop voltage or flux time derivative',pal=-2,/cb,xr=[0.02,0.5],offx=1,xsty=1,pos=posarr(/next),/noer;,zr=[-10,10]
endfig,/gs,/jp
end
