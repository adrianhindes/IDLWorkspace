pro genmat2, mat2=mat2,kza1=kza,sh=sh,iz=iz,thx=thx,thy=thy,p=p,str=str,kzaav=kzaav,indexlist=indexlist,useindex=useindex,lam=lam

gencarriers,sh=sh,th=[thx(iz(0)),thy(iz(1))],kx=kx,ky=ky,dkx=dkx,dky=dky,p=p,str=str,toutlist=toutlist,/noload,/quiet,tkz=kz,nkz=nkz,mat=mat,indexlist=indexlist,useindex=useindex,lam=lam
;kz0=kz
