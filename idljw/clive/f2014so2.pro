...
analbeam6,0,ans90x,ans90,1.,1,cmno=32 ;& ans70 *= sqrt(70./90.)
analbeam6,1,ans80x,ans80,1.,1,cmno=31;or33 ;& ans60 *= sqrt(60./90.)
...
legend,['80kV (b2) #9328','90kV (b1) #9328'],textcol=[1,2]


ans80b=congrid(ans80,91)
ans80b = ans80b / 2/!pi * 380
oplot,ans80b-ans80b(n/2),col=1


ans90b=congrid(ans90,91)
ans90b = ans90b / 2/!pi * 360
oplot,ans90b-ans90b(n/2),col=2
