...
str={roir:2560,roil:1,roit:2160,roib:1,pixsizemm:6.5e-3,binx:1,biny:1,mapstr:mapstr} & bin=32
...
ss=myrest2('~/idl/clive/nleonw/tang_port/objhidden_zb.sav')
...
lns1=(myrest2('~/idl/clive/nleonw/timg28/objhidden5.sav')).(0)
