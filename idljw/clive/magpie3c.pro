...
;dcal=getimgnew('cal348 27-06-2014',0,db='mcal')*1.
;dcal0=getimgnew('bg363 27-06-2014',0,db='mcal')*1.
;dcal=getimgnew(380,0,db='m')*1.
;dcal0=getimgnew(381,0,db='m')*1.
dcal=getimgnew(382,0,db='m')*1.
dcal0=getimgnew(383,0,db='m')*1.


dcal-=dcal0

newdemod,dcal,carscal,doplot=0,db=db,sh=sh,lam=488e-9,demodtype='magpie2'
carscal(*,*,1)=carscal(*,*,1)/carscal(*,*,0)
...
zd=pd
for i=0,nfr-1 do begin
   carquot=ss(*,*,i)/carscal(*,*,1);ss(*,*,iref)
