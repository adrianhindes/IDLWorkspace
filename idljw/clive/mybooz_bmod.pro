...
pro invmap,rmn,zmn,par,rout,zout,rhogrid,$
           rcthgrid,rsthgrid,bxgrid,bygrid,bzgrid,phi=phi,r1=r1,z1=z1,bmn=bmn,$
           bgrid=bgrid
...
for i=0,nrho-1 do begin
    ...
    evalsurfb,rmn,zmn,par,rt,zt,irhoarr(i),bxt,byt,bzt,phi=phi,theta=theta,bmn=bmn,bgrid=bgridt
    r1(i,*)=rt
    z1(i,*)=zt
    b1(i,*)=bgridt
    bx1(i,*)=bxt
...
bgrid=trigrid(r1,z1,b1,tri,gs,xout=rout,yout=zout)
...
pro evalsurfb,rmn,zmn,par,r,z,i,dx,dy,dz,phi=phi,theta=theta,bmn=bmn,bgrid=bgrid
...
for j=0,par.nmod-1 do begin
    ...
    bgrid=bgrid  + bmn(i,j)*cos(par.m(j)*theta-par.n(j)*phi)
...
pro rdflx, rmn,zmn, pars,file=fil,bmn=bmn
...
rdflx,rmn,zmn,par,fil=fil,bmn=bmn


;phir=(352.8+[-0.05,0.05]*40.)*!dtor - 2*!pi

phir=(30. +[-0.05,0.05] )*!dtor 
   ;[0,2*!pi/3.]
nphi=3;32;8;2;5.;*2
...
;    stop
    invmap,rmn,zmn,par,rout,zout,rhogrid,$
           rcthgrid,rsthgrid,bxgrid,bygrid,bzgrid,phi=phi,r1=r1a,z1=z1a,bmn=bmn,bgrid=bgrid
...
readpatch,99996,db='greg',str,nfr=1
...
read_spe,'~/share/greg/tshot  32.spe',l,t,d
...
;read_spe,'~/share/greg/shaun_900001.spe',l,t,d,st=str &lc0=[488,488,484]
;read_spe,'~/share/greg/shaun_900001.spe',l,t,d,st=str &lc0=[488,488,484]
...
;read_spe,'~/share/greg/shaun_84180.spe',l,t,d,st=str
;&lc0=[706,696,700]

;read_spe,'~/share/greg/shaun_84172 2014 September 25 12_34_15.spe',l,t,d,st=str &lc0=[487.5,487.5,491]

read_spe,'~/share/greg/shaun_'+string(sh,format='(I0)')+'.spe',l,t,d,st=str
...
;mkfig,'~/sp.eps',xsize=14,ysize=10,font_size=10
plotm,sig>0,xtitle='Spectrometer channel',ytitle='signal',title=string(sh,r2/r1,format='("#",I0,", rpeak=",G0)'),pos=posarr(1,3,0,cnx=0.1)

plot,reverse(linten),/noer,col=4,ysty=4,xsty=4,pos=posarr(/curr)

plot,rat1,ytitle='ratio',yr=[0,.6],pos=posarr(/next),/noer
plot,temp,yr=[0,20],pos=posarr(/curr),col=2,/noer,ysty=4,xsty=4
axis,!x.crange(1),!y.crange(0),yaxis=1,col=2,ytitle='temp eV'

plotm,l,reform(d(*,3,[iframe0,iframe])) ,/noer,pos=posarr(/next)
for i=0,nl-1 do begin
   for j=0,1 do begin
      js=[-1,1]
...
t=-22+findgen(11)*11.
stop
contourn2,reform(d(*,chan,*)),l,t,/cb,/bo,title=string(sh,chan)
end
