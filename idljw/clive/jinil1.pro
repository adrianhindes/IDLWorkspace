...
sh=9243
ifr=frameoftime(sh,0.34)&only2=1&demodtype='basic2013mse'
...
for i=0,nt-1 do begin
   ...
   ifr=frameoftime(sh,tarr(i))&only1=1&only2=0&demodtype='basic2013mse'
...
contourn2,reform(angs(*,iz0,*))-12,-r1,tarr,/cb,zr=[-10,10],pal=-2,pos=posarr(2,1,0,cny=0.1),xtitle='-Radius (cm)',ytitle='time (s)',title='Pitch angle vs Radius and time #'+string(sh,format='(I0)'),offx=1.,ztitle = 'pitch angle (deg)',xr=[-240,-160],/box
ig=indgen(5)*2

plotm,-r1,reform(angs(*,iz0,ig))-12,pos=posarr(/next),/noer,xtitle='-Radius (cm)',ytitle='Pol angle (degrees)',title='Pitch angle vs R for early times',yr=[-10,10],thick=2
oplot,!x.crange,[0,0]
