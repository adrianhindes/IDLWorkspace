...
80]
 parewn2b={nimg:17,$
      mode:'phase',$
      rarr:[replicate(144,100)],$ ; with mirr
;      rarr:[replicate(146,100)],$ ; no mirr
      iarr:1*iarr,$
      psi:0.5*linspace(0,180,17)*!dtor,$
      epsilon:fltarr(17),$
      sim:0,$
...
;par=parewn2b;is mirr

par=parewn3;145 is no mirr
...
for i=0,nimg-1 do begin
    ...
    if par.sim eq 0 then img=getimg(r,index=iarr(i),sm=1,pre='run',path='~/rsphy/kstartestimages')
