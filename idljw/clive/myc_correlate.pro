; $Id: //depot/Release/ENVI53_IDL85/idl/idldir/lib/c_correlate.pro#1 $
;
; Copyright (c) 1995-2015, Exelis Visual Information Solutions, Inc. All
...
;-
function myc_correlate, X, Y, Lag, Covariance = Covariance, Double = doubleIn,ipar=ipar
    ...
    Xd = x - ipar*TOTAL(X, Double = useDouble) / nX ;Deviations
    Yd = y - ipar*TOTAL(Y, Double = useDouble) / nX
