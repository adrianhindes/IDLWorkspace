...
;iarr=findgen(18)*10;183 images ; fix(linspace(000,900,70*4+1))
iarr=intspace(11*60,14*60);intspace(120,182)  + 700
...
ee:
mkfig,'~/rsphy/stability3_oven.eps',xsize=27,ysize=18,font_size=12
pp=parr
