...
;if sh ge 86439 and sh le 86450 then begin
;vfloat=mdsvalue2('\H1DATA::TOP.FLUCTUATIONS.CAMAC:A14_09:INPUT_3',/nozero)
;endif
...
volt.v=smooth(volt.v,10)
cur.v=smooth(cur.v,10)
