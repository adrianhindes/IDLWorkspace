...
function simimg_p3,s0,s1,s2,s3,mode=mode,dosynth=dosynth,deltawp=deltawp,opt=config
common cbb,x2,y2,f2
...
;tquartz=0.605e-3
par00={crystal:'quartz',thickness:tquartz,lambda:656e-9,facetilt:0.}
par0={crystal:'quartz',thickness:tquartz,lambda:656e-9,facetilt:0.};0.60005921e-3
par1={crystal:'bbo',thickness:3e-3,lambda:656e-9,facetilt:45*!dtor}
par2={crystal:'bbo',thickness:3e-3,lambda:656e-9,facetilt:45*!dtor}
par3={crystal:'bbo',thickness:5e-3,lambda:656e-9,facetilt:30*!dtor}
