...
fileali='~/idl/clive/nleonw/kmse_7891n2/irset.sav'&uc=getimg(7983,index=34,sm=4,path='/data/kstar/MSE_DATA')<2000 & imgbin=4 & uc=float(uc)&uc-=300&uc=uc>0&cmno=18&ii=200
