@ds_profile
fil='/home/cmichael/fromboyd/heliac/cfg53/output'

fil='/home/cmichael/fromboyd/heliac/cfg53/fromh1svr/gHg110324-kh0.530-kv1.000.hin.out'

fil='/home/cmichael/fromboyd/from_berhnard/HELIAC_NH4_HE1000_kh+0.730_kv+1.000_D20150916_T164030/xheliac.out'
...
readf,lun,linsunit;unit
readf,lun,lins;unit
;readf,lun,lins;unit
;readf,lun,lins;unit

;fmt='(I3,F6.1,F7.3,F7.3,F7.3,F7.3,F7.3,F7.1,F7.2,F7.2,F6.2)';10th and
;14th in by 1
fmt='(A3,A6  ,A7  ,A7  ,A7  ,A7  ,A7  ,A7  ,A7  ,A8  ,A7  ,A6  ,A7  ,A8  ,A8  ,A7  ,A6  ,A7  ,A8  )'
np=19
d=fltarr(np,50)
d1=strarr(np)
for i=0,12 do begin
...
;;   420 FORMAT(I3,3PF6.1,0PF7.3,F7.3,F7.3,F7.3,F7.3,F7.1,F7.2,F7.2,F6.2,  61770000
;;      &F6.2,F7.2,F7.3,F7.4,F7.2,F6.2,F7.2,F8.2b)                          61780000
