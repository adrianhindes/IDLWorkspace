...
print,'click for vert line'
cursor, dx, dy,/device,/down
plots,dx*[1,1],[0,d2*fc-1],color=3,/device,thick=2
...
temp=[4.64,10,21.5,46.4,100,215,464,1000.]
...
plot, temp, yy,psym=2
ratio=yy
;save,temp,ratio,file='~/schweer_te.sav',/verb
