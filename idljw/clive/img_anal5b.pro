...
for i=0,nrun-1 do begin
    img=getimg(rarr(i))
    demod, img,c1,c2a,c2b,s3,idx=idx,sub=sub,win='none'    ;,c1r,c2ar,c2br,p2a,p2b
...
for i=0,nrun-1 do begin
    img=getimg(rarr(i))
    demod, img,c1,c2a,c2b,s3,idxng=idx,thres=0.003;,/doplot;,sub=[512,384]
    sz=size(c1,/dim)
