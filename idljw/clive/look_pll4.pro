pro look_pll4,sh,twin,fr=fr,ylog=ylog,img=img,win=win,f0=f0,bw=bw,iframe=iframe,ccs=ccs,lmax=lmax,doiframe=doiframe,lockavg=lockavg,dolen=dolen
default,lmax,200
...
for i=0,6 do begin
lmax=50
look_pll4,sh,win=3,iframe=i,ccs=ccs,lmax=lmax,doiframe=1,lockavg=l1;,f0=23e3,bw=3e3
larr(i)=l1
